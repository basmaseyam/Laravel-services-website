    ...
    <section class="bredcrumb">
        ...
        <div class="">
            <ul class= "middle">
                ...
                <li><a class="inner" href="#">Single service</a></li>
            </ul>
        </div>
    </section>
    <!--Page Title Ends-->
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4 col-sm-12 col-xs-12">
                    ...
                    <ul class="list-group">
                        <li class="list-group-item active"><a href="service-details.html">Business Consulting</a></li>
                        <li class="list-group-item"><a href="service-single.html">Income Investments</a></li>
                        <li class="list-group-item"><a href="service-single.html">Customer Services</a></li>
                        <li class="list-group-item"><a href="service-single.html">Business Services Consulting</a></li>
                        <li class="list-group-item"><a href="service-single.html">Support Consulting</a></li>
                        <li class="list-group-item"><a href="service-single.html">Energy Environment Consulting</a></li>
                        <li class="list-group-item"><a href="service-single.html">Business Analytics</a></li>
                        <li class="list-group-item"><a href="service-single.html">Travel And Aviation Consulting</a></li>
                        <li class="list-group-item"><a href="service-single.html">Financial Services</a></li>
                    </ul>
                    <div class="question">
                ...
                <div class="col-md-8 col-sm-12 col-xs-12">
                    <div class="outer-box">
                        <div class="img-box"><img src="images/resources/service-1.png" alt=""></div>
